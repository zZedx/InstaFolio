      ...
      <div className="2xl:px-16 lg:pt-24 lg:pb-16 2xl:pt-48 pb-4 pt-8  md:px-16 px-8 sm:px-12 w-full flex-col xl:flex-row flex items-center justify-center gap-8 xl:gap-16 border-[#e34b71] relative border-b ">
        ...
        <div>
          ...
          <p className="mt-4 text-sm md:text-base xl:text-lg 2xl:text-lg text-pink-100">
            ...
            first projects come to life through HTML and CSS, and that initial
            spark ignited my relentless pursuit of knowledge in the field.
            Crafting user-friendly, aesthetically pleasing websites that offer
            exceptional user experiences is what drives me.
            <br />
            <br />
