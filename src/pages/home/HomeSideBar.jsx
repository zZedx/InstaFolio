...
const HomeSideBar = () => {
  return (
    <div
      className="lg:mt-10 space-y-6 lg:px-6 lg:pt-6 lg:pb-12 border border-white/10 bg-white/10 rounded-md"
    ...
    >
      ...
      <div className="flex justify-between">
        ...
        <a href="./resume.pdf" className="inline-block text-center bg-gradient-to-tl duration-300 from-red-500 to-pink-500 hover:gradient-to-br hover:from-pink-500 hover:to-red-500 transition-colors hover:text-red-100 text-red-100 font-bold w-full py-2 rounded">
          DOWNLOAD RESUME
        </a>
      <div>
